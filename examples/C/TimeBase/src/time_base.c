...
jp_gnss_gnss_config_t create_survey_in_config()
{
    ...
    config.time_base.base_mode = JP_GNSS_BASE_MODE_SURVEY_IN;
    config.time_base.survey_in.minimum_observation_time_s = 120;
    config.time_base.survey_in.required_position_accuracy_m = 50.0;
...
jp_gnss_gnss_config_t create_fixed_position_lla_config()
{
    ...
    config.has_time_base = true;
    config.time_base.base_mode = JP_GNSS_BASE_MODE_FIXED_POSITION;
    config.time_base.fixed_position.position_type = JP_GNSS_FIXED_POSITION_LLA;
    config.time_base.fixed_position.lla.latitude_deg  = 52.232222222;
    config.time_base.fixed_position.lla.longitude_deg = 21.008055556;
    config.time_base.fixed_position.lla.height_m      = 110.0;
    config.time_base.fixed_position.position_accuracy_m = 0.5;
...
jp_gnss_gnss_config_t create_fixed_position_ecef_config()
{
    ...
    config.has_time_base = true;
    config.time_base.base_mode = JP_GNSS_BASE_MODE_FIXED_POSITION;
    config.time_base.fixed_position.position_type = JP_GNSS_FIXED_POSITION_ECEF;
    config.time_base.fixed_position.ecef.x_m = 3656215.987;
    config.time_base.fixed_position.ecef.y_m = 1409547.654;
    config.time_base.fixed_position.ecef.z_m = 5049982.321;
    config.time_base.fixed_position.position_accuracy_m = 0.5;
